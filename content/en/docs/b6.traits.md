...
🔎 [`Copy`](https://doc.rust-lang.org/std/marker/trait.Copy.html) set the ability to duplicate via simply copying bits (pass by duplicating)
...
👨‍🏫 Try to implement [TryFrom](https://doc.rust-lang.org/std/convert/trait.TryFrom.html) and check the blanket implementation it provides.

## 👨‍🏫 Before going to the next...

- 💯 Check Trait implementation coherence and Orphan rules.
