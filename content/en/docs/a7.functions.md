...
- 💯 Usage of `::` and `.` to call functions in different modules,
  ...
  > [!assignment]
  > Refer [path separator and member access operators](/docs/operators/#path-separator--member-access) for more information about the usage of the `::` and `.` operators.
