...
- This project started as a Rust workspace to ensure future scalability.
- We chose [Hyper](https://github.com/hyperium/hyper), [Axum](https://github.com/tokio-rs/axum), [Tokio](https://tokio.rs) and [Tower ecosystem](https://github.com/tower-rs) as they are the most stable and prominent HTTP server ecosystem at the moment of writing.
- We chose [Toasty ORM](https://github.com/tokio-rs/toasty) as it is the most future-proofing object relational mapper at the moment of writing.
- We chose [Garde](https://github.com/jprochazk/garde) for input validation and [Utoipa](https://github.com/juhaku/utoipa) to generate the OpenAPI specification for our project.
- We chose [Docker](https://docs.docker.com/get-started/get-docker/) ([OrbStack for macOS users](https://orbstack.dev)) and [Docker Compose](https://docs.docker.com/compose/) for development setup and [PostgreSQL](https://www.postgresql.org) as the database.
