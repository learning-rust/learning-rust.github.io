...
Cargo is Rust’s built-in package manager. But mainly it uses to,

- Create a new project : `cargo new`
- Update dependencies : `cargo update`
- Build project : `cargo build`
- Analyze a project to see it has any errors, without building it : `cargo check`
- Build and run a project : `cargo run`  
- Run tests : `cargo test`  
- Generate documentation via rustdoc : `cargo doc`

In addition, there are some `cargo` commands, especially for publishing crates directly via `cargo`.
